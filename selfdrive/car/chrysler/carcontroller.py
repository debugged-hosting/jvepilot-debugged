...
class CarController():
  ...
  def update(self, enabled, CS, actuators, pcm_cancel_cmd, hud_alert, gas_resume_speed, jvepilot_state):
    ...
    apply_steer = True #apply_toyota_steer_torque_limits(new_steer, self.apply_steer_last,
    ...
    if CS.out.vEgo > (CS.CP.minSteerSpeed - 0. #5):  # for command high bit
      ...
      if CS.out.vEgo < (CS.CP.minSteerSpeed - 3.0):
        self.gone_fast_yet = True # False  # < 14.5m/s stock turns off this bit, but fine down to 13.5
